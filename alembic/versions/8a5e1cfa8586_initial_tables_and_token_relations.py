...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_refresh_tokens_access_token_id'), 'refresh_tokens', ['access_token_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_refresh_tokens_access_token_id'), table_name='refresh_tokens')
